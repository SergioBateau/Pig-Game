...
document.querySelector(".btn-roll").addEventListener("click", function() {
  if(gamePlaying) {
    ...
    var pick1 = 'dice-' + dice1 + '.png'; // название картинки
    var pick2 = 'dice-' + dice2 + '.png'; // название картинки
    
    var src = './images/'; // доступ к картинкам
    
    document.getElementById('dice-1').src = src + pick1;
    document.getElementById('dice-2').src = src + pick2;
